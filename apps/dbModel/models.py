...
class Admintb(db.Model, UserMixin):

    __tablename__ = 'Admintb'
...
class Payment(db.Model):
    ...
    def __repr__(self):
        return f"{self.tokn},{self.stat},{self.end},{self.month},{self.val},"
